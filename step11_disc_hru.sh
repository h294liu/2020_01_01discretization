...
# (1) reclassify
# DEM range is [0,79]. Three thresholds: slp_thrsh1, slp_thrsh2, slp_thrsh3.
...
# (1) reclassify
# DEM range is [0,360]. Three thresholds: slp_thrsh1, slp_thrsh2, slp_thrsh3,slp_thrsh4, slp_thrsh5.
